...
function ii(e, r) {
  return openBlock(), createElementBlock("svg", ai, r[0] || (r[0] = [
    createBaseVNode("g", { style: { transform: "translate(2px, 2px)" } }, [
...
function ui(e, r) {
  return openBlock(), createElementBlock("svg", si, r[0] || (r[0] = [
    createStaticVNode('<g style="transform:translate(2px, 2px);"><g><path data-type="shape" d="M0,0 L0,34 L163,34 L163,0" class="dv-button-svg-bg"></path></g><path data-type="polyline" d="M0,0 L164.1,0" class="dv-button-svg-line"></path><path data-type="polyline" d="M163,0 L163,34" class="dv-button-svg-line"></path><path data-type="polyline" d="M164.1,34 L0,34" class="dv-button-svg-line"></path><path data-type="polyline" d="M1.1,34 L1.1,0" class="dv-button-svg-line"></path></g>', 1)
  ]));
}
var ci = Ke(li, [["render", ui]]);
var fi = {};
var di = {
  viewBox: "0 0 167 38",
  preserveAspectRatio: "none",
...
function hi(e, r) {
  return openBlock(), createElementBlock("svg", di, r[0] || (r[0] = [
    createStaticVNode('<g style="transform:translate(2px, 2px);"><g><path data-type="shape" d="M1,1 L1,33 L162,33 L162,1" class="dv-button-svg-bg"></path></g><path data-type="polyline" d="M0,0 L0,10" class="dv-button-svg-line"></path><path data-type="polyline" d="M-1.1,0 L10,0" class="dv-button-svg-line"></path><path data-type="polyline" d="M164.1,0 L153,0" class="dv-button-svg-line"></path><path data-type="polyline" d="M163,0 L163,10" class="dv-button-svg-line"></path><path data-type="polyline" d="M164.1,34 L153,34" class="dv-button-svg-line"></path><path data-type="polyline" d="M163,34 L163,24" class="dv-button-svg-line"></path><path data-type="polyline" d="M0,34 L0,24" class="dv-button-svg-line"></path><path data-type="polyline" d="M-1.1,34 L10,34" class="dv-button-svg-line"></path></g>', 1)
  ]));
}
var vi = Ke(fi, [["render", hi]]);
var pi = {};
var gi = {
  viewBox: "0 0 187 38",
  preserveAspectRatio: "none",
...
function mi(e, r) {
  return openBlock(), createElementBlock("svg", gi, r[0] || (r[0] = [
    createBaseVNode("g", { style: { transform: "translate(2px, 2px)" } }, [
      createBaseVNode("g", null, [
        createBaseVNode("path", {
          "data-type": "shape",
...
function Ci(e, r) {
  return openBlock(), createElementBlock("svg", xi, r[0] || (r[0] = [
    createBaseVNode("g", { style: { transform: "translate(2px, 2px)" } }, [
      createBaseVNode("g", null, [
        createBaseVNode("path", {
          "data-type": "shape",
...
function wi(e, r) {
  return openBlock(), createElementBlock("svg", Pi, r[0] || (r[0] = [
    createStaticVNode('<g style="transform:translate(2px, 2px);"><g><path data-type="shape" d="M0,0 L0,34 L163,34 L163,0" class="dv-button-svg-bg"></path></g><path data-type="polyline" d="M0,0 L81.6,0" class="dv-button-svg-line"></path><path data-type="polyline" d="M163,0 L81.4,0" class="dv-button-svg-line"></path><path data-type="polyline" d="M0,34 L81.6,34" class="dv-button-svg-line"></path><path data-type="polyline" d="M163,34 L81.4,34" class="dv-button-svg-line"></path><path data-type="polyline" d="M0,1 L10,1" class="dv-button-svg-line"></path><path data-type="polyline" d="M163,1 L153,1" class="dv-button-svg-line"></path><path data-type="polyline" d="M0,33 L10,33" class="dv-button-svg-line"></path><path data-type="polyline" d="M163,33 L153,33" class="dv-button-svg-line"></path></g>', 1)
  ]));
}
var ki = Ke(_i, [["render", wi]]);
var Ai = { class: "dv-button-wrapper" };
var Li = { class: "dv-button" };
var Si = { class: "dv-button-svg-container" };
var Oi = { class: "dv-button-text" };
var Gi = defineComponent({
  ...
  setup(e) {
    ...
    const r = e, a = computed(() => ln(r.color, 40)), t = computed(() => r.fontColor === "" ? r.color : r.fontColor), n = computed(() => ln(t.value, 40)), l = computed(() => r.bg ? 0.1 : 0), o = computed(() => `${r.fontSize}px`);
    return (_, x) => (openBlock(), createElementBlock("div", Ai, [
      createBaseVNode("button", Li, [
        createBaseVNode("div", Si, [
          (openBlock(), createBlock(resolveDynamicComponent(_.border)))
        ]),
...
var Ri = typeof window < "u" && typeof document < "u";
typeof WorkerGlobalScope < "u" && globalThis instanceof WorkerGlobalScope;
var Di = Object.prototype.toString;
var Ti = (e) => Di.call(e) === "[object Object]";
var sn = () => {
};
function Fi(e, r) {
  function a(...t) {
...
function Ei(...e) {
  ...
  }, _ = (E, U, T, L) => (E.addEventListener(U, T, L), () => E.removeEventListener(U, T, L)), x = watch(
    () => [Wi(r), Rt(n)],
    ([E, U]) => {
      if (o(), !E)
        return;
...
function xe(e, r, a) {
  const t = ref(0), n = ref(0);
  let l, o = null, _ = null;
  const x = (L = true) => new Promise((d) => {
    nextTick(() => {
      _ = e.value, t.value = e.value ? e.value.clientWidth : 0, n.value = e.value ? e.value.clientHeight : 0, e.value ? (!t.value || !n.value) && console.warn("DataV: Component width or height is 0px, rendering abnormality may occur!") : console.warn("DataV: Failed to get dom node, component rendering may be abnormal!"), typeof r == "function" && L && r(), d(true);
    });
  }), z = () => {
    l = Ni(x, 200);
  }, E = () => {
    ...
    await x(false), z(), E(), typeof a == "function" && a();
  };
  return onMounted(() => {
    T();
  }), onUnmounted(() => {
    U();
  }), onActivated(T), onDeactivated(U), {
    width: t,
    height: n,
    initWH: x
  };
...
var Xi = ["d", "fill"];
var Qi = ["fill", "x", "y"];
var Yi = ["xlink:href", "width", "height", "x", "y"];
var Ki = ["fill", "x", "y"];
var Ji = {
  __name: "index",
  props: {
  ...
  setup(e) {
    ...
    const r = e, a = ref(null), { width: t, height: n } = xe(a, x, _), l = reactive({
      defaultConfig: {
        /**
      ...
      mergedConfig: null,
      column: []
    }), o = computed(() => `${r.config.fontSize ? r.config.fontSize : l.defaultConfig.fontSize}px`);
    watch(() => r.config, () => {
      z();
    }, {
      deep: true
    ...
    return (L, d) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(), createElementBlock("svg", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(l).column, (B, W) => (openBlock(), createElementBlock("g", { key: W }, [
          createBaseVNode("path", {
            d: B.d,
            fill: unref(l).mergedConfig.columnColor
          }, null, 8, Xi),
          createBaseVNode("text", {
            fill: unref(l).mergedConfig.textColor,
            x: B.x,
            y: unref(n) - 4
          }, toDisplayString(B.name), 9, Qi),
          unref(l).mergedConfig.img.length ? (openBlock(), createElementBlock("image", {
            key: 0,
            "xlink:href": unref(l).mergedConfig.img[W % unref(l).mergedConfig.img.length],
            width: unref(l).mergedConfig.imgSideLength,
            height: unref(l).mergedConfig.imgSideLength,
            x: B.x - unref(l).mergedConfig.imgSideLength / 2,
            y: B.y - unref(l).mergedConfig.imgSideLength
          }, null, 8, Yi)) : createCommentVNode("", true),
          unref(l).mergedConfig.showValue ? (openBlock(), createElementBlock("text", {
            key: 1,
            fill: unref(l).mergedConfig.textColor,
            x: B.x,
            y: B.textY
          }, toDisplayString(B.value), 9, Ki)) : createCommentVNode("", true)
        ]))), 128))
      ], 8, Ui))
    ], 512));
  }
...
var Zi = ["id"];
var eo = ["offset", "stop-color"];
var to = ["id", "x2"];
var ro = ["offset", "stop-color"];
var no = ["x", "y", "rx", "ry", "stroke-width", "stroke", "width", "height"];
var ao = ["stroke-width", "stroke-dasharray", "stroke", "points"];
var io = ["stroke", "fill", "x", "y"];
var oo = {
  __name: "index",
  props: {
    config: {
  ...
  setup(e) {
    const r = e, a = He(), t = ref(null), n = reactive({
    ...
    }), E = computed(() => n.mergedConfig && n.mergedConfig.localGradient ? n.gradientId1 : n.gradientId2), U = computed(() => {
      if (!n.mergedConfig)
        return "100%";
    ...
    return (W, q) => (openBlock(), createElementBlock("div", {
      ref_key: "percentPond",
      ref: t,
      ...
      (openBlock(), createElementBlock("svg", null, [
        createBaseVNode("defs", null, [
          createBaseVNode("linearGradient", {
            id: unref(n).gradientId1,
            x1: "0%",
            y1: "0%",
            x2: "100%",
            y2: "0%"
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(z), (G) => (openBlock(), createElementBlock("stop", {
              key: G[0],
              offset: `${G[0]}%`,
              "stop-color": G[1]
            }, null, 8, eo))), 128))
        ...
        createBaseVNode("rect", {
          x: unref(n).mergedConfig ? unref(n).mergedConfig.borderWidth / 2 : "0",
          y: unref(n).mergedConfig ? unref(n).mergedConfig.borderWidth / 2 : "0",
          rx: unref(n).mergedConfig ? unref(n).mergedConfig.borderRadius : "0",
          ry: unref(n).mergedConfig ? unref(n).mergedConfig.borderRadius : "0",
          fill: "transparent",
          "stroke-width": unref(n).mergedConfig ? unref(n).mergedConfig.borderWidth : "0",
          stroke: `url(#${unref(n).gradientId1})`,
          width: unref(l) > 0 ? unref(l) : 0,
          height: unref(o) > 0 ? unref(o) : 0
        }, null, 8, no),
        createBaseVNode("polyline", {
          "stroke-width": unref(x),
          "stroke-dasharray": unref(n).mergedConfig ? unref(n).mergedConfig.lineDash.join(",") : "0",
          stroke: `url(#${unref(E)})`,
          points: unref(_)
        }, null, 8, ao),
        createBaseVNode("text", {
          stroke: unref(n).mergedConfig ? unref(n).mergedConfig.textColor : "#fff",
          fill: unref(n).mergedConfig ? unref(n).mergedConfig.textColor : "#fff",
          x: unref(n).width / 2,
          y: unref(n).height / 2
        }, toDisplayString(unref(T)), 9, io)
      ]))
    ], 512));
  }
};
...
function lo(e) {
  ...
  return Object.defineProperty(a, "__esModule", { value: true }), Object.keys(e).forEach(function(t) {
...
function Be() {
  return pn || (pn = 1, function(e) {
    function r(a) {
      ...
      }, e.exports.__esModule = true, e.exports.default = e.exports, r(a);
    }
    e.exports = r, e.exports.__esModule = true, e.exports.default = e.exports;
  }(Xt)), Xt.exports;
}
...
function Te() {
  return Pn || (Pn = 1, function(e) {
    ...
    e.exports = l, e.exports.__esModule = true, e.exports.default = e.exports;
  }(Yt)), Yt.exports;
}
var rr = { exports: {} };
var wn;
...
function po() {
  return An || (An = 1, function(e) {
    function r(a, t) {
      ...
      if (n != null) {
        var l, o, _, x, z = [], E = true, U = false;
        try {
          if (_ = (n = n.call(a)).next, t === 0) {
            if (Object(n) !== n) return;
            E = false;
          } else for (; !(E = (l = _.call(n)).done) && (z.push(l.value), z.length !== t); E = true) ;
        } catch (T) {
          U = true, o = T;
        } finally {
          try {
...
function yo() {
  return Gn || (Gn = 1, function(e) {
    ...
    var a = r(Ne()), t = r(Te());
    function n(z) {
      var E = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, U = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0.25, T = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0.25;
    ...
    function l(z, E) {
      var U = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, T = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0.25, L = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 0.25, d = z.length;
      if (!(d < 3 || E >= d)) {
        var B = E - 1;
        B < 0 && (B = U ? d + B : 0);
        var W = E + 1;
  ...
  return Rn || (Rn = 1, function(e) {
    ...
    function T(A) {
      ...
      if (A && (0, n.default)(A) === "object")
        for (var u in A)
          A.hasOwnProperty(u) && (A[u] && (0, n.default)(A[u]) === "object" ? ee[u] = T(A[u], true) : ee[u] = A[u]);
      return ee;
    }
    function L(A) {
    ...
    function q(A, p, V, X, ee, u, I) {
      ...
      var Q = u - ee;
      if (Q >= U * 2) return true;
      var te = (0, t.default)(A, 2), oe = te[0], ve = te[1], Y = $(p, V, X, ee), ie = (0, t.default)(Y, 2), ce = ie[0], fe = ie[1], N = $(p, V, X, u), w = (0, t.default)(N, 2), O = w[0], F = w[1], H = [oe - p, ve - V], re = [ce - p, fe - V], h2 = [O - p, F - V], j = Q > U;
      if (j) {
        var s = T([h2, re]), b = (0, t.default)(s, 2);
        re = b[0], h2 = b[1];
      }
      var P = G(re, H) && !G(h2, H);
...
function bo() {
  return Dn || (Dn = 1, function(e) {
    ...
    var a = r(Te());
    function t(o, _) {
      var x = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, z = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
      if (!o || _.length < 2) return false;
      x && o.beginPath(), _.forEach(function(E, U) {
        return E && (U === 0 ? o.moveTo.apply(o, (0, a.default)(E)) : o.lineTo.apply(o, (0, a.default)(E)));
      }), z && o.closePath();
    }
    function n(o, _) {
      var x = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, z = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, E = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
      if (!o || !_) return false;
  ...
  return Tn || (Tn = 1, function(e) {
    ...
    var a = r(Te()), t = r(Ne()), n = r(cn()), l = Fe(), o = bo(), _ = n.default.polylineToBezierCurve, x = n.default.bezierCurveToPolyline, z = {
      ...
      validator: function(C) {
        ...
        return typeof c != "number" || typeof M != "number" || typeof A != "number" ? (console.error("Circle shape configuration is abnormal!"), false) : true;
      },
      draw: function(C, $) {
        var c = C.ctx, M = $.shape;
        c.beginPath();
    ...
    var E = {
      ...
      validator: function(C) {
        ...
        return typeof c != "number" || typeof M != "number" || typeof A != "number" || typeof p != "number" ? (console.error("Ellipse shape configuration is abnormal!"), false) : true;
      },
      draw: function(C, $) {
        var c = C.ctx, M = $.shape;
        c.beginPath();
    ...
    var U = {
      ...
      validator: function(C) {
        ...
        return typeof c != "number" || typeof M != "number" || typeof A != "number" || typeof p != "number" ? (console.error("Rect shape configuration is abnormal!"), false) : true;
      },
      draw: function(C, $) {
        var c = C.ctx, M = $.shape;
        c.beginPath();
    ...
    var T = {
      ...
      validator: function(C) {
        var $ = C.shape, c = $.rx, M = $.ry, A = $.r;
        return typeof c != "number" || typeof M != "number" || typeof A != "number" ? (console.error("Ring shape configuration is abnormal!"), false) : true;
      },
      draw: function(C, $) {
        var c = C.ctx, M = $.shape;
        c.beginPath();
    ...
    var m = {
      ...
      validator: function(C) {
        ...
        return typeof c != "string" ? (console.error("Text content should be a string!"), false) : M instanceof Array ? typeof A != "number" ? (console.error("Text rowGap should be a number!"), false) : true : (console.error("Text position should be an array!"), false);
      },
      draw: function(C, $) {
  ...
  return Fn || (Fn = 1, function(e) {
    ...
    function a() {
      ...
      function u(g) {
        this.tryEntries = [{
          tryLoc: "root"
        }], g.forEach(X, this), this.reset(true);
      }
      function I(g) {
        if (g || g === "") {
          var v = g[z];
          ...
          if (!isNaN(g.length)) {
            var S = -1, J = function Q() {
              for (; ++S < g.length; ) if (o.call(g, S)) return Q.value = g[S], Q.done = false, Q;
              return Q.value = t, Q.done = true, Q;
            };
            return J.next = J;
          }
        }
      ...
      return f.prototype = D, _(c, "constructor", {
        ...
        return S.reverse(), function Q() {
          for (; S.length; ) {
            var te = S.pop();
            if (te in v) return Q.value = te, Q.done = false, Q;
          }
        ...
        constructor: u,
        reset: function(v) {
          if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = false, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(ee), !v) for (var S in this) S.charAt(0) === "t" && o.call(this, S) && !isNaN(+S.slice(1)) && (this[S] = t);
        },
        stop: function() {
          this.done = true;
        ...
        dispatchException: function(v) {
          ...
          for (var Q = this.tryEntries.length - 1; Q >= 0; --Q) {
            ...
            if (te.tryLoc <= this.prev) {
              ...
              if (ve && Y) {
                if (this.prev < te.catchLoc) return J(te.catchLoc, true);
...
function _o() {
  return Wn || (Wn = 1, function(e) {
    ...
    e.default = o, o.prototype.colorProcessor = function(L) {
      var d = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, B = d ? n.getColorFromRgbValue : n.getRgbaValue, W = ["fill", "stroke", "shadowColor"], q = Object.keys(L), G = q.filter(function(D) {
    ...
    function U(L) {
      ...
      if (W !== "linear" && W !== "radial")
        return console.warn("GradientType only supports linear or radial, current value is " + W), false;
      var m = B.length;
      return W === "linear" && m !== 4 || W === "radial" && m !== 6 ? (console.warn("The expected length of gradientParams is " + (W === "linear" ? "4" : "6")), false) : q !== "fill" && q !== "stroke" ? (console.warn("GradientWith only supports fill or stroke, current value is " + q), false) : G !== "auto" && !(G instanceof Array) ? (console.warn("gradientStops only supports 'auto' or Number Array ([0, .5, 1]), current value is " + G), false) : true;
    }
    function T(L) {
      var d = 1 / (L.length - 1);
    ...
    o.prototype.restoreTransform = function(L) {
      ...
      var L = (0, l.deepClone)(this, true);
      return this.colorProcessor(L, true), L;
    };
  }(mr)), mr;
}
var yr = {};
...
function wo() {
  return En || (En = 1, function(e) {
    ...
    function o(f) {
      var D = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, k = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, C = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 30, $ = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
      if (!_.apply(void 0, arguments)) return false;
      try {
        var c = x(f), M = z(c, C);
    ...
    function _(f) {
      var D = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, k = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, C = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 30;
      if (!f || D === false || k === false || !C)
      ...
      var $ = (0, t.default)(k);
      return $ === "string" || $ === "boolean" || !f.length ? (console.error("transition: Unsupported Data Type of State!"), false) : (!n.default.has(f) && !(f instanceof Array) && console.warn("transition: Transition curve not found, default curve will be used!"), true);
    }
    function x(f) {
      var D = "";
...
function ko() {
  return zn || (zn = 1, function(e) {
    ...
    var a = r(Co()), t = r($o()), n = r(Be()), l = r(Te()), o = r(mt()), _ = r(_o()), x = r(wo()), z = Fe(), E = function T(L, d) {
      (0, o.default)(this, T), d = (0, z.deepClone)(d, true);
      var B = {
        /**
    ...
    e.default = E, E.prototype.addedProcessor = function() {
      ...
      if (!T || L === void 0) return false;
      var d = (0, n.default)(this[T]) === "object";
      d && (L = (0, z.deepClone)(L, true));
      var B = this.render;
      ...
      var T = (0, t.default)(
        a.default.mark(function L(d, B) {
          var W, q, G, m, y, f, D, k, C, $ = arguments;
          return a.default.wrap(function(M) {
            for (; ; )
              switch (M.prev = M.next) {
                case 0:
                  if (W = $.length > 2 && $[2] !== void 0 ? $[2] : false, !(d !== "shape" && d !== "style")) {
                    M.next = 4;
                    break;
                  }
                  return console.error("Only supported shape and style animation!"), M.abrupt("return");
                case 4:
                  if (B = (0, z.deepClone)(B, true), d === "style" && this.style.colorProcessor(B), q = this[d], G = Object.keys(B), m = {}, G.forEach(function(A) {
                    return m[A] = q[A];
                  }), y = this.animationFrame, f = this.animationCurve, D = this.animationDelay, k = (0, x.default)(f, m, B, y, true), this.animationRoot.push(q), this.animationKeys.push(G), this.animationFrameState.push(k), !W) {
                    M.next = 17;
                    break;
                  }
  ...
  return qn || (qn = 1, function(e) {
    ...
    function U(G) {
      for (var m = 1; m < arguments.length; m++) {
        ...
        m % 2 ? E(y, true).forEach(function(f) {
          (0, a.default)(G, f, y[f]);
    ...
    var T = function G(m) {
      ...
      m.setAttribute("width", f), m.setAttribute("height", D), this.ctx = y, this.area = k, this.animationStatus = false, this.graphs = [], this.color = l.default, this.bezierCurve = o.default, m.addEventListener("mousedown", B.bind(this)), m.addEventListener("mousemove", W.bind(this)), m.addEventListener("mouseup", q.bind(this));
    };
    e.default = T, T.prototype.clearArea = function() {
      ...
      if (!m)
        return this.animationStatus = true, new Promise(function(y) {
          L.call(G, function() {
            G.animationStatus = false, y();
          }, Date.now());
        });
    };
    function L(G, m) {
    ...
    T.prototype.clone = function(G) {
      ...
      return delete y.render, y = (0, _.deepClone)(y, true), this.add(y);
    };
  }(Ht)), Ht;
}
(function(e) {
...
var Ga = Aa(jt);
var Lo = { class: "dv-water-pond-level" };
var So = { key: 0 };
var Oo = ["id"];
var Go = ["offset", "stop-color"];
var Mo = ["stroke", "fill", "x", "y"];
var Ro = ["cx", "cy", "rx", "ry", "stroke"];
var Do = ["rx", "ry", "width", "height", "stroke"];
var To = {
  __name: "index",
  props: {
    config: Object,
  ...
  setup(e) {
    ...
    async function G(m = 1) {
      ...
      }), await n.renderer.launchAnimation(), n.animation = false, n.renderer.graphs.length && G(m + 1);
    }
    return (m, y) => (openBlock(), createElementBlock("div", Lo, [
      unref(n).renderer ? (openBlock(), createElementBlock("svg", So, [
        createBaseVNode("defs", null, [
          createBaseVNode("linearGradient", {
            id: unref(n).gradientId,
            x1: "0%",
            y1: "0%",
            x2: "0%",
            y2: "100%"
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n).svgBorderGradient, (f) => (openBlock(), createElementBlock("stop", {
              key: f[0],
              offset: f[0],
              "stop-color": f[1]
            }, null, 8, Go))), 128))
        ...
        unref(n).renderer ? (openBlock(), createElementBlock("text", {
          key: 0,
          stroke: `url(#${unref(n).gradientId})`,
          fill: `url(#${unref(n).gradientId})`,
          x: unref(n).renderer.area[0] / 2 + 8,
          y: unref(n).renderer.area[1] / 2 + 8
        }, toDisplayString(unref(n).details), 9, Mo)) : createCommentVNode("", true),
        !unref(o) || unref(o) === "round" ? (openBlock(), createElementBlock("ellipse", {
          key: 1,
          cx: unref(n).renderer.area[0] / 2 + 8,
          cy: unref(n).renderer.area[1] / 2 + 8,
          rx: unref(n).renderer.area[0] / 2 + 5,
          ry: unref(n).renderer.area[1] / 2 + 5,
          stroke: `url(#${unref(n).gradientId})`
        }, null, 8, Ro)) : (openBlock(), createElementBlock("rect", {
          key: 2,
          x: "2",
          y: "2",
          rx: unref(o) === "roundRect" ? 10 : 0,
          ry: unref(o) === "roundRect" ? 10 : 0,
          width: unref(n).renderer.area[0] + 12,
          height: unref(n).renderer.area[1] + 12,
          stroke: `url(#${unref(n).gradientId})`
        }, null, 8, Do))
      ...
      createBaseVNode("canvas", {
        ...
        ref: t,
        style: normalizeStyle(`border-radius: ${unref(l)};`)
      }, null, 4)
    ]));
  }
};
...
var Vo = ["dur"];
var Uo = ["id"];
var Xo = ["xlink:href", "fill"];
var Qo = ["xlink:href", "fill", "mask"];
var Yo = ["xlink:href", "width", "height", "x", "y"];
var Ko = ["fill", "x", "y"];
var Jo = ["id", "d"];
var Zo = ["xlink:href", "stroke-width", "stroke"];
var el = ["id"];
var tl = ["r", "fill"];
var rl = ["dur", "path"];
var nl = ["xlink:href", "stroke-width", "stroke", "mask"];
var al = ["from", "to", "dur"];
var il = {
  __name: "index",
  props: {
  ...
  setup(e) {
    const r = e, a = He(), t = ref(null), { width: n, height: l } = xe(t, z, x), o = reactive({
      unique: Math.random(),
    ...
    async function q() {
      await nextTick(), o.flylineLengths = o.flylines.map(({ key: m }) => _.proxy.$refs[m][0].getTotalLength());
    }
 ...
 Relative Position is [${f}, ${D}]`);
    ...
    return (m, y) => (openBlock(), createElementBlock("div", {
      ...
      style: normalizeStyle(`background-image: url(${unref(o).mergedConfig ? unref(o).mergedConfig.bgImgSrc : ""})`),
      onClick: G
    }, [
      unref(o).flylines.length ? (openBlock(), createElementBlock("svg", {
        key: 0,
        width: unref(n),
        height: unref(l)
      }, [
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o).flylinePoints, (f) => (openBlock(), createElementBlock("g", {
          key: f.key + Math.random()
        }, [
          createBaseVNode("defs", null, [
            f.halo.show ? (openBlock(), createElementBlock("circle", {
              key: 0,
              id: `halo${unref(o).unique}${f.key}`,
              cx: f.coordinate[0],
              cy: f.coordinate[1]
            }, [
          ...
          createBaseVNode("mask", {
            id: `mask${unref(o).unique}${f.key}`
          }, [
            f.halo.show ? (openBlock(), createElementBlock("use", {
              key: 0,
              "xlink:href": `#halo${unref(o).unique}${f.key}`,
              fill: `url(#${unref(o).haloGradientId})`
            }, null, 8, Xo)) : createCommentVNode("", true)
          ], 8, Uo),
          f.halo.show ? (openBlock(), createElementBlock("use", {
            key: 0,
            "xlink:href": `#halo${unref(o).unique}${f.key}`,
            fill: f.halo.color,
            mask: `url(#mask${unref(o).unique}${f.key})`
          }, null, 8, Qo)) : createCommentVNode("", true),
          f.icon.show ? (openBlock(), createElementBlock("image", {
            ...
            x: f.icon.x,
            y: f.icon.y
          }, null, 8, Yo)) : createCommentVNode("", true),
          f.text.show ? (openBlock(), createElementBlock("text", {
            ...
            x: f.text.x,
            y: f.text.y
          }, toDisplayString(f.name), 13, Ko)) : createCommentVNode("", true)
        ]))), 128)),
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o).flylines, (f, D) => (openBlock(), createElementBlock("g", {
          key: f.key + Math.random()
        }, [
          createBaseVNode("defs", null, [
            createBaseVNode("path", {
          ...
          createBaseVNode("mask", {
            ...
            createBaseVNode("circle", {
              ...
              cy: "0",
              r: f.radius,
              fill: `url(#${unref(o).flylineGradientId})`
            }, [
          ...
          unref(o).flylineLengths[D] ? (openBlock(), createElementBlock("use", {
            key: 0,
            "xlink:href": `#${f.key}`,
            "stroke-width": f.width,
            stroke: f.color,
            ...
            createBaseVNode("animate", {
              ...
              from: `0, ${unref(o).flylineLengths[D]}`,
              to: `${unref(o).flylineLengths[D]}, 0`,
              dur: f.time,
              repeatCount: "indefinite"
            }, null, 8, al)
          ], 8, nl)) : createCommentVNode("", true)
        ]))), 128))
      ], 8, Eo)) : createCommentVNode("", true)
    ], 4));
  }
};
var $r = {
...
var cl = ["values", "dur"];
var fl = ["dur"];
var dl = ["xlink:href", "width", "height", "x", "y"];
var hl = ["id"];
var vl = ["xlink:href", "fill"];
var pl = ["xlink:href", "fill", "mask"];
var gl = ["id", "d"];
var ml = ["xlink:href", "stroke-width", "stroke"];
var yl = ["xlink:href", "stroke-width", "stroke", "mask"];
var bl = ["from", "to", "dur"];
var xl = ["id"];
var Cl = ["r", "fill"];
var $l = ["dur", "path"];
var _l = ["xlink:href", "width", "height", "x", "y"];
var Pl = ["fill", "x", "y"];
var wl = {
  __name: "index",
  props: {
  ...
  setup(e) {
    ...
    async function W() {
      await nextTick(), o.lengths = o.paths.map((y, f) => _.proxy.$refs[`path${f}`][0].getTotalLength());
    }
    function q() {
 ...
 Relative Position is [${D}, ${k}]`);
    ...
    return (y, f) => (openBlock(), createElementBlock("div", {
      ...
      style: normalizeStyle(`background-image: url(${unref(o).mergedConfig ? unref(o).mergedConfig.bgImgUrl : ""})`),
      onClick: m
    }, [
      unref(o).mergedConfig ? (openBlock(), createElementBlock("svg", {
        key: 0,
        width: unref(n),
        height: unref(l)
      }, [
        createBaseVNode("defs", null, [
          ...
          unref(o).paths[0] ? (openBlock(), createElementBlock("circle", {
            key: 0,
            id: `circle${unref(o).paths[0].toString()}`,
            cx: unref(o).paths[0][2][0],
            cy: unref(o).paths[0][2][1]
          }, [
            createBaseVNode("animate", {
              attributeName: "r",
              values: `1;${unref(o).mergedConfig.halo.radius}`,
              dur: `${unref(o).mergedConfig.halo.duration / 10}s`,
              repeatCount: "indefinite"
            }, null, 8, cl),
            createBaseVNode("animate", {
              attributeName: "opacity",
        ...
        unref(o).paths[0] ? (openBlock(), createElementBlock("image", {
          key: 0,
          "xlink:href": unref(o).mergedConfig.centerPointImg.url,
          width: unref(o).mergedConfig.centerPointImg.width,
          height: unref(o).mergedConfig.centerPointImg.height,
          x: unref(o).paths[0][2][0] - unref(o).mergedConfig.centerPointImg.width / 2,
          y: unref(o).paths[0][2][1] - unref(o).mergedConfig.centerPointImg.height / 2
        }, null, 8, dl)) : createCommentVNode("", true),
        createBaseVNode("mask", {
          id: `maskhalo${unref(o).paths[0].toString()}`
        }, [
          unref(o).paths[0] ? (openBlock(), createElementBlock("use", {
            key: 0,
            "xlink:href": `#circle${unref(o).paths[0].toString()}`,
            fill: `url(#${unref(o).gradient2Id})`
          }, null, 8, vl)) : createCommentVNode("", true)
        ], 8, hl),
        unref(o).paths[0] && unref(o).mergedConfig.halo.show ? (openBlock(), createElementBlock("use", {
          key: 1,
          "xlink:href": `#circle${unref(o).paths[0].toString()}`,
          fill: unref(o).mergedConfig.halo.color,
          mask: `url(#maskhalo${unref(o).paths[0].toString()})`
        }, null, 8, pl)) : createCommentVNode("", true),
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o).paths, (D, k) => (openBlock(), createElementBlock("g", { key: k }, [
          createBaseVNode("defs", null, [
            createBaseVNode("path", {
              id: `path${D.toString()}`,
              ref_for: true,
          ...
          createBaseVNode("use", {
            ...
            "stroke-width": unref(o).mergedConfig.lineWidth,
            stroke: unref(o).mergedConfig.orbitColor
          }, null, 8, ml),
          unref(o).lengths[k] ? (openBlock(), createElementBlock("use", {
            key: 0,
            "xlink:href": `#path${D.toString()}`,
            "stroke-width": unref(o).mergedConfig.lineWidth,
            stroke: unref(o).mergedConfig.flylineColor,
            mask: `url(#mask${unref(o).unique}${D.toString()})`
          }, [
            createBaseVNode("animate", {
              attributeName: "stroke-dasharray",
              from: `0, ${unref(o).lengths[k]}`,
              to: `${unref(o).lengths[k]}, 0`,
              dur: unref(o).times[k] || 0,
              repeatCount: "indefinite"
            }, null, 8, bl)
          ], 8, yl)) : createCommentVNode("", true),
          createBaseVNode("mask", {
            id: `mask${unref(o).unique}${D.toString()}`
          }, [
            createBaseVNode("circle", {
              cx: "0",
              cy: "0",
              r: unref(o).mergedConfig.flylineRadius,
              fill: `url(#${unref(o).gradientId})`
            }, [
              createBaseVNode("animateMotion", {
                dur: unref(o).times[k] || 0,
          ...
          createBaseVNode("image", {
            "xlink:href": unref(o).mergedConfig.pointsImg.url,
            width: unref(o).mergedConfig.pointsImg.width,
            height: unref(o).mergedConfig.pointsImg.height,
            x: D[0][0] - unref(o).mergedConfig.pointsImg.width / 2,
            y: D[0][1] - unref(o).mergedConfig.pointsImg.height / 2
          }, null, 8, _l),
          createBaseVNode("text", {
            style: normalizeStyle(`fontSize:${unref(o).mergedConfig.text.fontSize}px;`),
            fill: unref(o).mergedConfig.text.color,
            x: D[0][0] + unref(o).mergedConfig.text.offset[0],
            y: D[0][1] + unref(o).mergedConfig.text.offset[1]
          }, toDisplayString(unref(o).texts[k]), 13, Pl)
        ]))), 128))
...
var kl = { class: "ranking-info" };
var Al = { class: "rank" };
var Ll = ["innerHTML"];
var Sl = { class: "ranking-value" };
var Ol = { class: "ranking-column" };
var Gl = {
  __name: "index",
  props: {
    config: {
  ...
  setup(e) {
    ...
    const r = e, a = ref(null), { height: t } = xe(a, E, z), n = reactive({
      defaultConfig: {
        /**
    ...
    const l = computed(() => r.config.textColor ? r.config.textColor : n.defaultConfig.textColor), o = computed(() => r.config.color ? r.config.color : n.defaultConfig.color), _ = computed(() => De(o.value, 50)), x = computed(() => `${r.config.fontSize ? r.config.fontSize : n.defaultConfig.fontSize}px`);
    onUnmounted(() => {
      q();
    });
    function z() {
    ...
    const B = computed(() => n.mergedConfig.carousel === "single");
    async function W(G = false) {
    ...
    return (G, m) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n).rows, (y, f) => (openBlock(), createElementBlock("div", {
        key: y.toString() + y.scroll,
        class: "row-item",
        style: normalizeStyle(`height: ${unref(n).heights[f]}px;`)
      }, [
        createBaseVNode("div", kl, [
          createBaseVNode("div", Al, " No." + toDisplayString(y.ranking), 1),
          createBaseVNode("div", {
            class: "info-name",
            innerHTML: y.name
          }, null, 8, Ll),
          createBaseVNode("div", Sl, toDisplayString(unref(n).mergedConfig.valueFormatter ? unref(n).mergedConfig.valueFormatter(y) : y.value + unref(n).mergedConfig.unit), 1)
        ]),
        createBaseVNode("div", Ol, [
          createBaseVNode("div", {
            class: "inside-column",
            style: normalizeStyle(`width: ${y.percent}%;`)
          }, m[0] || (m[0] = [
            createBaseVNode("div", { class: "shine" }, null, -1)
          ]), 4)
        ])
      ], 4))), 128))
    ], 512));
...
var Ml = Ke(Gl, [["__scopeId", "data-v-26f5f75f"]]);
var Pr = {
  install(e) {
    e.component("DvScrollRankingBoard", Ml);
  }
};
var Rl = ["align", "innerHTML"];
var Dl = ["align", "onClick", "onMouseenter", "innerHTML"];
var Tl = {
  __name: "index",
  props: {
    config: {
  ...
  setup(e, { expose: r, emit: a }) {
    const t = e, n = a, l = ref(null), { width: o, height: _ } = xe(l, T, U), x = reactive({
      defaultConfig: {
        /**
    ...
    function E(k, C, $, c, M) {
      ...
      x.mergedConfig.hoverPause && (k ? f() : y(true));
    }
    function U() {
      L();
    }
    ...
    async function y(k = false) {
      x.needCalc && (W(), G(), x.needCalc = false);
    ...
    function D(k, C) {
      x.mergedConfig = {
        ...x.mergedConfig,
        data: [...k]
      }, x.needCalc = true, typeof C == "number" && (x.animationIndex = C), x.animationHandler || y(true);
    }
    return (k, C) => (openBlock(), createElementBlock("div", {
      ref_key: "scrollBoard",
      ref: l,
      ...
      unref(x).mergedConfig ? (openBlock(), createElementBlock("div", {
        key: 1,
        class: "rows",
        style: normalizeStyle(`height: ${unref(_) - (unref(x).header.length ? unref(x).mergedConfig.headerHeight : 0)}px;`)
      }, [
        ...
        `)
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList($.ceils, (M, A) => (openBlock(), createElementBlock("div", {
            key: `${M}${c}${A}`,
            class: "ceil",
            style: normalizeStyle(`width: ${unref(x).widths[A]}px;`),
            align: unref(x).aligns[A],
            onClick: (p) => z(c, A, $, M),
            onMouseenter: (p) => E(true, c, A, $, M),
            onMouseleave: C[0] || (C[0] = (p) => E(false)),
            innerHTML: M
          }, null, 44, Dl))), 128))
        ], 4))), 128))
      ], 4)) : createCommentVNode("", true)
...
function ze() {
  ...
  function T(d, B, W) {
    return d = d.filter(function(q) {
      ...
      return l((0, t.deepClone)(B, true), q);
    }), d.filter(function(q) {
      var G = q.show;
      return G;
    });
...
function Un(e) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    r % 2 ? Vn(Object(a), true).forEach(function(t) {
...
var El = {
  ...
  draw: function(r, a) {
    ...
    for (var W = 0; W < _; W++) {
      t.beginPath();
      var q = (0, vt.getCircleRadianPoint)(L, d, T, E + B * W), G = (0, vt.getCircleRadianPoint)(L, d, T, E + B * (W + 1)), m = (0, Wl.getLinearGradientColor)(t, q, G, [o[W], o[W + 1]]), y = E + B * W, f = E + B * (W + 1), D = false;
      if (f > U && (f = U, D = true), t.arc(L, d, T, y, f), t.strokeStyle = m, t.stroke(), D) break;
    }
  }
};
var zl = {
  ...
  validator: function(r) {
    ...
    return !(t instanceof Array) || typeof n != "string" || !(l instanceof Array) ? (console.error("NumberText shape configuration is abnormal!"), false) : true;
  },
  draw: function(r, a) {
...
var ql = {
  ...
  validator: function(r) {
    ...
    return typeof t != "number" || typeof n != "number" || typeof l != "number" || typeof o != "number" ? (console.error("lineIcon shape configuration is abnormal!"), false) : true;
  },
  draw: function(r, a) {
    var t = r.ctx, n = a.shape;
    t.beginPath();
...
function Zl() {
  ...
  var e = Ue(), r = Fe(), a = ze();
  function t(n) {
    var l = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, o = (0, r.deepClone)(e.colorConfig, true), _ = l.color, x = l.series;
...
function Xe() {
  ...
  function z(U, T) {
    ...
    L.forEach(function(d) {
      d === "shape" || d === "style" ? U.animation(d, T[d], true) : U[d] = T[d];
    });
  }
  function E() {
...
function es() {
  ...
  function o(E) {
    ...
    U.title && (T[0] = (0, l.deepMerge)((0, t.deepClone)(n.titleConfig, true), U.title)), (0, a.doUpdate)({
      chart: E,
      series: T,
      key: "title",
      getGraphConfig: _
...
function ts() {
  ...
  function x(d) {
    for (var B = 1; B < arguments.length; B++) {
      ...
      B % 2 ? _(Object(W), true).forEach(function(q) {
        (0, a.default)(d, q, W[q]);
  ...
  function z(d) {
    ...
    W = (0, o.deepMerge)((0, n.deepClone)(l.gridConfig, true), W || {}), (0, t.doUpdate)({
      chart: d,
      series: [W],
      key: "grid",
      getGraphConfig: E
...
function rs() {
  ...
  function E(s) {
    for (var b = 1; b < arguments.length; b++) {
      ...
      b % 2 ? z(Object(P), true).forEach(function(R) {
        (0, t.default)(s, R, P[R]);
  ...
  function q(s) {
    ...
    return b.forEach(function(R) {
      typeof R.boundaryGap != "boolean" && (R.boundaryGap = false);
    }), P.forEach(function(R) {
      typeof R.boundaryGap != "boolean" && (R.boundaryGap = true);
    }), [].concat((0, n.default)(b), (0, n.default)(P));
  }
  function G(s, b) {
  ...
  function re(s) {
    var b = s.animationCurve, P = s.animationFrame, R = s.rLevel, K = h2(s), ne = j(s);
    return K.map(function(ue) {
      return {
        name: "polyline",
        index: R,
...
function ns() {
  ...
  function E(Y) {
    for (var ie = 1; ie < arguments.length; ie++) {
      ...
      ie % 2 ? z(Object(ce), true).forEach(function(fe) {
  ...
  function q(Y, ie) {
    var ce = ie.findIndex(function(ne) {
      var ue = ne.data;
      return ue === "value";
    }), fe = ie[ce], N = ie[1 - ce], w = fe.linePosition, O = fe.axis, F = N.tickPosition, H = F.length, re = O === "x" ? 0 : 1, h2 = w[0][re], j = w[1][re], s = j - h2, b = fe.maxValue, P = fe.minValue, R = b - P, K = new Array(H).fill(0).map(function(ne, ue) {
      var de = Y[ue];
      if (typeof de != "number") return null;
      var he = (de - P) / R;
      return R === 0 && (he = 0), he * s + h2;
    });
  ...
  function G(Y) {
    ...
    if (N < 0 && w > 0) {
      var H = w - N, re = Math.abs(fe[0][O] - fe[1][O]), h2 = Math.abs(N) / H * re;
      ce === "y" && (h2 *= -1), F += h2;
    }
    return {
      changeIndex: O,
...
function as() {
  ...
  function z(h2, j) {
    var s = Object.keys(h2);
    if (Object.getOwnPropertySymbols) {
      var b = Object.getOwnPropertySymbols(h2);
      j && (b = b.filter(function(P) {
        return Object.getOwnPropertyDescriptor(h2, P).enumerable;
      })), s.push.apply(s, b);
    }
    return s;
  }
  function E(h2) {
    for (var j = 1; j < arguments.length; j++) {
      ...
      j % 2 ? z(Object(s), true).forEach(function(b) {
        (0, a.default)(h2, b, s[b]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(h2, Object.getOwnPropertyDescriptors(s)) : z(Object(s)).forEach(function(b) {
        Object.defineProperty(h2, b, Object.getOwnPropertyDescriptor(s, b));
      });
    }
    return h2;
  }
  function U(h2) {
    ...
    s && b && P && (R = (0, x.initNeedSeries)(P, o.barConfig, "bar"), R = T(R, h2), R = L(R), R = k(R)), (0, l.doUpdate)({
      chart: h2,
      series: R.slice(-1),
      key: "backgroundBar",
      getGraphConfig: V
  ...
  function W(h2) {
    var j = [];
    return h2.forEach(function(s) {
      var b = s.stack;
      b && j.push(b);
    }), (0, n.default)(new Set(j));
  }
  function q(h2) {
    var j = (0, n.default)(new Set(h2.map(function(s) {
      var b = s.barIndex;
      return b;
    }))).length;
  ...
  function G(h2) {
    var j = h2.slice(-1)[0], s = j.barCategoryGap, b = j.labelAxis.tickGap, P = 0;
    typeof s == "number" ? P = s : P = (1 - parseInt(s) / 100) * b, h2.forEach(function(R) {
      return R.barCategoryWidth = P;
    });
  }
  function m(h2) {
    var j = h2.slice(-1)[0], s = j.barCategoryWidth, b = j.barWidth, P = j.barGap, R = j.barNum, K = [];
    typeof b == "number" || b !== "auto" ? K = y(s, b, P) : b === "auto" && (K = f(s, b, P, R));
    var ne = K, ue = (0, t.default)(ne, 2), de = ue[0], he = ue[1];
    h2.forEach(function(pe) {
      pe.barWidth = de, pe.barGap = he;
    });
  }
  function y(h2, j, s) {
    var b = 0, P = 0;
    return typeof j == "number" ? b = j : b = parseInt(j) / 100 * h2, typeof s == "number" ? P = s : P = parseInt(s) / 100 * b, [b, P];
  }
  function f(h2, j, s, b) {
    var P = 0, R = 0, K = h2 / b;
    if (typeof s == "number")
  ...
  function D(h2) {
    var j = h2.slice(-1)[0], s = j.barGap, b = j.barWidth, P = j.barNum, R = (s + b) * P - s;
    h2.forEach(function(K) {
      return K.barAllWidthAndGap = R;
    });
  }
  function k(h2, j) {
    return h2 = $(h2), h2 = C(h2), h2 = M(h2), h2 = A(h2), h2;
  }
  function C(h2) {
    return h2.map(function(j) {
  ...
  function $(h2) {
    return h2.map(function(j) {
      var s = (0, x.mergeSameStackData)(j, h2);
      s = c(j, s);
  ...
  function p(h2, j, s, b, P) {
    if (typeof s != "number") return null;
    var R = j - h2, K = P === "x" ? 0 : 1, ne = b[1][K] - b[0][K], ue = (s - h2) / R;
    R === 0 && (ue = 0);
    var de = ue * ne;
    return de + b[0][K];
  }
  function V(h2) {
    var j = h2.animationCurve, s = h2.animationFrame, b = h2.rLevel, P = X(h2), R = u(h2);
    return P.map(function(K) {
      return {
        name: "rect",
        index: b,
        visible: h2.backgroundBar.show,
        animationCurve: j,
        animationFrame: s,
        shape: K,
        style: R
  ...
  function X(h2) {
    var j = h2.labelAxis, s = h2.valueAxis, b = j.tickPosition, P = s.axis, R = s.linePosition, K = ee(h2), ne = K / 2, ue = P === "x" ? 0 : 1, de = b.map(function(ye) {
      return ye[1 - ue];
  ...
  function ee(h2) {
    var j = h2.barAllWidthAndGap, s = h2.barCategoryWidth, b = h2.backgroundBar, P = b.width;
    return typeof P == "number" ? P : P === "auto" ? j : parseInt(P) / 100 * s;
  }
  function u(h2) {
    return h2.backgroundBar.style;
  }
  function I(h2) {
    var j = h2.barLabelAxisPos, s = h2.animationCurve, b = h2.animationFrame, P = h2.rLevel, R = g(h2);
  ...
  function v(h2, j) {
    var s = h2.shapeType;
    return s === "leftEchelon" ? S(h2, j) : s === "rightEchelon" ? J(h2, j) : Q(h2, j);
  }
  function S(h2, j) {
    var s = h2.barValueAxisPos, b = h2.barLabelAxisPos, P = h2.barWidth, R = h2.echelonOffset, K = (0, t.default)(s[j], 2), ne = K[0], ue = K[1], de = b[j], he = P / 2, pe = h2.valueAxis.axis, ge = [];
  ...
  function Q(h2, j) {
    var s = h2.barValueAxisPos, b = h2.barLabelAxisPos, P = h2.barWidth, R = (0, t.default)(s[j], 2), K = R[0], ne = R[1], ue = b[j], de = h2.valueAxis.axis, he = {};
    return de === "x" ? (he.x = K, he.y = ue - P / 2, he.w = ne - K, he.h = P) : (he.x = ue - P / 2, he.y = ne, he.w = P, he.h = K - ne), he;
  }
  function te(h2, j) {
    var s = h2.barStyle, b = h2.gradient, P = h2.color, R = h2.independentColor, K = h2.independentColors, ne = [s.fill || P], ue = (0, x.deepMerge)(ne, b.color);
    if (R) {
      var de = K[j % K.length];
  ...
  function oe(h2, j) {
    var s = h2.barValueAxisPos, b = h2.barLabelAxisPos, P = h2.data, R = h2.valueAxis, K = R.linePosition, ne = R.axis, ue = (0, t.default)(s[j], 2), de = ue[0], he = ue[1], pe = b[j], ge = P[j], ye = (0, t.default)(K, 2), Oe = ye[0], Qe = ye[1], Je = ne === "x" ? 0 : 1, Ye = he;
    return h2.gradient.local || (Ye = ge < 0 ? Oe[Je] : Qe[Je]), ne === "y" ? [pe, Ye, pe, de] : [Ye, pe, de, pe];
  }
  function ve(h2) {
    var j = I(h2), s = h2.shapeType;
    return j.forEach(function(b) {
      var P = b.shape;
      s === "leftEchelon" ? P = Y(P, h2) : s === "rightEchelon" ? P = ie(P, h2) : P = ce(P, h2), b.shape = P;
    }), j;
  }
  function Y(h2, j) {
    var s = j.valueAxis.axis;
    h2 = (0, _.deepClone)(h2);
    var b = h2, P = b.points, R = s === "x" ? 0 : 1, K = P[2][R];
  ...
  function ce(h2, j) {
    var s = j.valueAxis.axis, b = h2.x, P = h2.y, R = h2.w, K = h2.h;
  ...
  function fe(h2, j, s, b) {
    var P = b.chart.render, R = g(j);
    h2[s] && h2[s][0].name !== R && (h2[s].forEach(function(K) {
      return P.delGraph(K);
    }), h2[s] = null);
  }
  function N(h2) {
    var j = h2.animationCurve, s = h2.animationFrame, b = h2.rLevel, P = w(h2), R = re(h2);
    return P.map(function(K) {
      return {
        name: "text",
        index: b,
        visible: h2.label.show,
        animationCurve: j,
        animationFrame: s,
        shape: K,
        style: R
  ...
  function O(h2) {
    var j = h2.data, s = h2.label, b = s.formatter;
  ...
  function F(h2) {
    var j = h2.label, s = h2.barValueAxisPos, b = h2.barLabelAxisPos, P = j.position, R = j.offset, K = h2.valueAxis.axis;
  ...
  function H(h2, j) {
    var s = (0, t.default)(h2, 2), b = s[0], P = s[1], R = (0, t.default)(j, 2), K = R[0], ne = R[1];
    return [b + K, P + ne];
  }
  function re(h2) {
    var j = h2.color, s = h2.label.style, b = h2.gradient.color;
...
function is() {
  ...
  function E(w) {
    for (var O = 1; O < arguments.length; O++) {
      ...
      O % 2 ? z(Object(F), true).forEach(function(H) {
        (0, r.default)(w, H, F[H]);
  ...
  function T(w, O) {
    ...
    return w.forEach(function(H) {
      var re = H.center;
      re = re.map(function(h2, j) {
        return typeof h2 == "number" ? h2 : parseInt(h2) / 100 * F[j];
      }), H.center = re;
    }), w;
  }
  function L(w, O) {
    ...
    return w.forEach(function(H) {
      var re = H.radius, h2 = H.data;
      re = d(re, F), h2.forEach(function(j) {
        var s = j.radius;
  ...
  function B(w, O) {
    ...
    return F.forEach(function(H) {
      var re = H.radius, h2 = H.data, j = H.roseSort, s = q(H), b = (0, n.default)(h2);
      h2 = W(h2), h2.forEach(function(P, R) {
        P.radius[1] = re[1] - s * R;
      }), j ? h2.reverse() : H.data = b, H.roseIncrement = s;
    }), w;
  }
  function W(w) {
  ...
  function q(w) {
    ...
    if (F === "auto") {
      ...
      }, []), h2 = Math.min.apply(Math, (0, n.default)(re)), j = Math.max.apply(Math, (0, n.default)(re));
      return (j - h2) * 0.6 / (H.length - 1 || 1);
    }
  ...
  function G(w) {
    return w.forEach(function(O) {
      ...
      var h2 = (0, x.mulAdd)(F.slice(0, -1).map(function(j) {
        var s = j.percent;
        return s;
      }));
      F.slice(-1)[0].percent = 100 - h2, F.slice(-1)[0].percentForLabel = m(100 - h2, H);
    }), w;
  }
  function m(w) {
    var O = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, F = w.toString(), H = F.split("."), re = H[1] || "0", h2 = re.slice(0, O);
    return H[1] = h2, parseFloat(H.join("."));
  }
  function y(w) {
  ...
  function f(w) {
    return w.forEach(function(O) {
      ...
      H.forEach(function(re, h2) {
        var j = D(H, h2), s = (0, t.default)(j, 2), b = s[0], P = s[1];
  ...
  function C(w, O) {
    var F = w.center, H = O.startAngle, re = O.endAngle, h2 = (0, t.default)(O.radius, 2), j = h2[0], s = h2[1], b = (j + s) / 2, P = (H + re) / 2;
  ...
  function $(w) {
    return w.forEach(function(O) {
      ...
      F.forEach(function(re) {
        var h2 = re.startAngle, j = re.endAngle, s = re.radius, b = (h2 + j) / 2, P = _.getCircleRadianPoint.apply(void 0, (0, n.default)(H).concat([s[1], b]));
        re.edgeCenterPos = P;
      });
    }), w;
  }
  function c(w) {
    return w.forEach(function(O) {
      var F = p(O), H = p(O, false);
      F = V(F), H = V(H), X(F, O), X(H, O, false);
    }), w;
  }
  function M(w) {
  ...
  function p(w) {
    var O = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true, F = w.data, H = w.center, re = H[0];
    return F.filter(function(h2) {
      var j = h2.edgeCenterPos, s = j[0];
      return O ? s <= re : s > re;
    });
  }
  function V(w) {
    return w.sort(function(O, F) {
      ...
      H[0];
      var re = H[1], h2 = (0, t.default)(F.edgeCenterPos, 2);
      h2[0];
      var j = h2[1];
      if (re > j) return 1;
      if (re < j) return -1;
  ...
  function X(w, O) {
    var F = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true, H = O.center, re = O.outsideLabel, h2 = M(O);
    w.forEach(function(j) {
      var s = j.edgeCenterPos, b = j.startAngle, P = j.endAngle, R = re.labelLineEndLength, K = (b + P) / 2, ne = _.getCircleRadianPoint.apply(void 0, (0, n.default)(H).concat([h2, K])), ue = (0, n.default)(ne);
  ...
  function u(w) {
    ...
    return H.forEach(function(re, h2) {
      re.animationCurve = F, re.animationDelay = h2 * O, re.shape.or = re.shape.ir;
    }), H;
  }
  function I(w) {
    w.animationDelay = 0;
  ...
  function g(w, O) {
    var F = w.center, H = w.data, re = H[O], h2 = re.radius, j = re.startAngle, s = re.endAngle;
    return {
      startAngle: j,
      endAngle: s,
      ir: h2[0],
  ...
  function v(w, O) {
    var F = w.pieStyle, H = w.data, re = H[O], h2 = re.color;
    return (0, x.deepMerge)({
      fill: h2
    }, F);
  }
  ...
  function J(w, O) {
    var F = w.insideLabel, H = w.data, re = F.formatter, h2 = H[O], j = (0, a.default)(re), s = "";
    return j === "string" && (s = re.replace("{name}", h2.name), s = s.replace("{percent}", h2.percentForLabel), s = s.replace("{value}", h2.value)), j === "function" && (s = re(h2)), {
      content: s,
      position: h2.insideLabelPos
    };
  }
  function Q(w, O) {
  ...
  function Y(w, O) {
    var F = w.outsideLabel, H = w.data, re = F.labelLineStyle, h2 = H[O].color;
    return (0, x.deepMerge)({
      stroke: h2,
  ...
  function fe(w, O) {
    var F = w.outsideLabel, H = w.data, re = F.formatter, h2 = H[O], j = h2.labelLine, s = h2.name, b = h2.percentForLabel, P = h2.value, R = (0, a.default)(re), K = "";
  ...
  function N(w, O) {
    var F = w.outsideLabel, H = w.data, re = H[O], h2 = re.color, j = re.align, s = F.style;
...
function os() {
  ...
  function z(u) {
    for (var I = 1; I < arguments.length; I++) {
      ...
      I % 2 ? x(Object(g), true).forEach(function(v) {
        (0, a.default)(u, v, g[v]);
  ...
  function m(u, I) {
    ...
    if (oe = (0, _.deepMerge)((0, o.deepClone)(oe, true), {
      lineWidth: ve
    }), !te.length) return oe;
    var ce = te.length;
...
function ls() {
  ...
  function U(p) {
    for (var V = 1; V < arguments.length; V++) {
      ...
      V % 2 ? E(Object(X), true).forEach(function(ee) {
...
function ss() {
  ...
  function U(N) {
    for (var w = 1; w < arguments.length; w++) {
      ...
      w % 2 ? E(Object(O), true).forEach(function(F) {
        (0, r.default)(N, F, O[F]);
  ...
  function L(N, w) {
    ...
    return N.forEach(function(F) {
      var H = F.center;
      H = H.map(function(re, h2) {
        return typeof re == "number" ? re : parseInt(re) / 100 * O[h2];
      }), F.center = H;
    }), N;
  }
  function d(N, w) {
  ...
  function B(N, w) {
    var O = w.render.area, F = Math.min.apply(Math, (0, n.default)(O)) / 2;
    return N.forEach(function(H) {
      var re = H.radius, h2 = H.data, j = H.arcLineWidth;
      h2.forEach(function(s) {
  ...
  function W(N, w) {
    return N.forEach(function(O) {
      var F = O.startAngle, H = O.endAngle, re = O.data, h2 = O.min, j = O.max, s = H - F, b = j - h2;
      re.forEach(function(P) {
        var R = P.value, K = Math.abs((R - h2) / b * s);
  ...
  function q(N, w) {
    return N.forEach(function(O) {
      var F = O.data;
      F.forEach(function(H) {
        var re = H.color, h2 = H.gradient;
        (!h2 || !h2.length) && (h2 = re), h2 instanceof Array || (h2 = [h2]), H.gradient = h2;
      });
    }), N;
  }
  function G(N, w) {
    return N.forEach(function(O) {
      var F = O.startAngle, H = O.endAngle, re = O.splitNum, h2 = O.center, j = O.radius, s = O.arcLineWidth, b = O.axisTick, P = b.tickLength, R = b.style.lineWidth, K = H - F, ne = j - s / 2, ue = ne - P, de = K / (re - 1), he = 2 * Math.PI * j * K / (Math.PI * 2), pe = Math.ceil(R / 2) / he * K;
      O.tickAngles = [], O.tickInnerRadius = [], O.tickPosition = new Array(re).fill(0).map(function(ge, ye) {
        var Oe = F + de * ye;
        return ye === 0 && (Oe += pe), ye === re - 1 && (Oe -= pe), O.tickAngles[ye] = Oe, O.tickInnerRadius[ye] = ue, [_.getCircleRadianPoint.apply(void 0, (0, n.default)(h2).concat([ne, Oe])), _.getCircleRadianPoint.apply(void 0, (0, n.default)(h2).concat([ue, Oe]))];
      });
    }), N;
  }
  function m(N, w) {
    return N.forEach(function(O) {
      var F = O.center, H = O.tickInnerRadius, re = O.tickAngles, h2 = O.axisLabel.labelGap, j = re.map(function(b, P) {
        return _.getCircleRadianPoint.apply(void 0, (0, n.default)(F).concat([H[P] - h2, re[P]]));
      }), s = j.map(function(b) {
  ...
  function y(N, w) {
    return N.forEach(function(O) {
      var F = O.axisLabel, H = O.min, re = O.max, h2 = O.splitNum, j = F.data, s = F.formatter, b = (re - H) / (h2 - 1), P = new Array(h2).fill(0).map(function(K, ne) {
  ...
  function f(N, w) {
    return N.forEach(function(O) {
      var F = O.data, H = O.details, re = O.center, h2 = H.position, j = H.offset, s = F.map(function(b) {
        var P = b.startAngle, R = b.endAngle, K = b.radius, ne = null;
        return h2 === "center" ? ne = re : h2 === "start" ? ne = _.getCircleRadianPoint.apply(void 0, (0, n.default)(re).concat([K, P])) : h2 === "end" && (ne = _.getCircleRadianPoint.apply(void 0, (0, n.default)(re).concat([K, R]))), k(ne, j);
      });
      O.detailsPosition = s;
    }), N;
  }
  function D(N, w) {
    return N.forEach(function(O) {
      var F = O.data, H = O.details, re = H.formatter, h2 = (0, a.default)(re), j = F.map(function(s) {
        var b = s.value;
        return h2 === "string" && (b = re.replace("{value}", "{nt}"), b = b.replace("{name}", s.name)), h2 === "function" && (b = re(s)), b.toString();
      });
      O.detailsContent = j;
    }), N;
  }
  function k(N, w) {
    var O = (0, t.default)(N, 2), F = O[0], H = O[1], re = (0, t.default)(w, 2), h2 = re[0], j = re[1];
    return [F + h2, H + j];
  }
  function C(N) {
    var w = N.tickPosition, O = N.animationCurve, F = N.animationFrame, H = N.rLevel;
    return w.map(function(re, h2) {
      return {
        name: "polyline",
        index: H,
  ...
  function g(N, w) {
    var O = N.data, F = N.center, H = N.endAngle, re = O[w], h2 = re.radius, j = re.startAngle, s = re.endAngle, b = re.localGradient;
    return b && (H = s), {
      rx: F[0],
      ry: F[1],
      r: h2,
  ...
  function v(N, w) {
    var O = N.data, F = N.dataItemStyle, H = O[w], re = H.lineWidth, h2 = H.gradient;
    return h2 = h2.map(function(j) {
  ...
  function J(N, w) {
    ...
    if (F > H)
      ...
      var re = O.slice(-1)[0];
      O.push.apply(O, (0, n.default)(new Array(H - F).fill(0).map(function(h2) {
  ...
  function oe(N) {
    var w = N.startAngle, O = N.endAngle, F = N.min, H = N.max, re = N.data, h2 = N.pointer, j = N.center, s = h2.valueIndex, b = h2.style, P = re[s] ? re[s].value : 0, R = (P - F) / (H - F) * (O - w) + w + Math.PI / 2;
    return (0, x.deepMerge)({
  ...
  function ve(N) {
    var w = (0, t.default)(N, 2), O = w[0], F = w[1], H = [O, F - 40], re = [O + 5, F], h2 = [O, F + 10], j = [O - 5, F];
    return [H, re, h2, j];
  }
  function Y(N) {
  ...
  function ce(N, w) {
    var O = N.detailsPosition, F = N.detailsContent, H = N.data, re = N.details, h2 = O[w], j = F[w], s = H[w].value, b = re.valueToFixed;
    return {
      number: [s],
      content: j,
      position: h2,
...
function us() {
  ...
  function x(u) {
    ...
    g ? (g = (0, _.deepMerge)((0, l.deepClone)(o.legendConfig, true), g), g = z(g), g = E(g, I, u), g = U(g, u), g = d(g, u), g = [g]) : g = [], (0, n.doUpdate)({
      chart: u,
      series: g,
      key: "legendIcon",
      getGraphConfig: $
  ...
  function E(u, I, g) {
    var v = I.series, S = g.legendStatus, J = u.data.filter(function(Q) {
      ...
      return oe ? (Q.color || (Q.color = oe.color), Q.icon || (Q.icon = oe.type), Q) : false;
    });
    return (!S || S.length !== u.data.length) && (S = new Array(u.data.length).fill(true)), J.forEach(function(Q, te) {
  ...
  function V(u, I) {
    ...
    return (0, _.deepMerge)((0, l.deepClone)(te, true), Q);
  }
  function X(u, I) {
...
var ds = {
  ...
  setup(e) {
    const r = e, a = ref(null), t = ref(null);
    let n = reactive({});
    xe(t, _, l), watch(() => r.option, () => {
      n && n.setOption(r.option, true);
    }, { deep: true });
    function l() {
      o();
    }
    ...
    return (x, z) => (openBlock(), createElementBlock("div", {
...
var hs = { class: "dv-capsule-chart" };
var vs = { class: "label-column" };
var ps = { class: "capsule-container" };
var gs = {
  key: 0,
  class: "capsule-item-value"
};
var ms = { class: "unit-label" };
var ys = {
  key: 0,
  class: "unit-text"
};
var bs = {
  ...
  setup(e) {
    ...
    const t = computed(() => `${r.config.fontSize ? r.config.fontSize : a.defaultConfig.fontSize}px`), n = computed(() => r.config.textColor ? r.config.textColor : a.defaultConfig.textColor);
    function l() {
      o(), _();
    }
    function o() {
    ...
    return onMounted(() => {
      l();
    }), (x, z) => (openBlock(), createElementBlock("div", hs, [
      unref(a).mergedConfig ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        createBaseVNode("div", vs, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(a).mergedConfig.data, (E) => (openBlock(), createElementBlock("div", {
            key: E.name
          }, toDisplayString(E.name), 1))), 128)),
          z[0] || (z[0] = createBaseVNode("div", null, " ", -1))
        ]),
        createBaseVNode("div", ps, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(a).capsuleLength, (E, U) => (openBlock(), createElementBlock("div", {
            key: U,
            class: "capsule-item"
          }, [
            createBaseVNode("div", {
              class: "capsule-item-column",
              style: normalizeStyle(`width: ${E * 100}%; background-color: ${unref(a).mergedConfig.colors[U % unref(a).mergedConfig.colors.length]};`)
            }, [
              unref(a).mergedConfig.showValue ? (openBlock(), createElementBlock("div", gs, toDisplayString(unref(a).capsuleValue[U]), 1)) : createCommentVNode("", true)
            ], 4)
          ]))), 128)),
          createBaseVNode("div", ms, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(a).labelData, (E, U) => (openBlock(), createElementBlock("div", {
              key: E + U
            }, toDisplayString(E), 1))), 128))
          ])
        ]),
        unref(a).mergedConfig.unit ? (openBlock(), createElementBlock("div", ys, toDisplayString(unref(a).mergedConfig.unit), 1)) : createCommentVNode("", true)
...
var Ba = {
  ...
  setup(e) {
    const r = e, a = ref(null), t = reactive({
      renderer: null,
      defaultConfig: {
        /**
    ...
    function E() {
      ...
      U(t.graph, d), t.graph.animationCurve = T, t.graph.animationFrame = L, t.graph.animation("style", B, true), t.graph.animation("shape", d);
    }
    function U(T, L) {
      const d = T.shape.number.length, B = L.number.length;
      d !== B && (T.shape.number = L.number);
    }
    return (T, L) => (openBlock(), createElementBlock("div", xs, [
      createBaseVNode("canvas", {
        ref_key: "digitalFlop",
        ref: a
      }, null, 512)
...
var Cs = { class: "dv-active-ring-chart" };
var $s = { class: "active-ring-info" };
var _s = { key: 0 };
var Ps = {
  __name: "index",
  props: {
  ...
  setup(e) {
    ...
    }), _ = computed(() => t.mergedConfig ? t.mergedConfig.data[t.activeIndex].name : ""), x = computed(() => t.mergedConfig ? `font-size: ${t.mergedConfig.digitalFlopStyle.fontSize}px;` : ""), z = computed(() => r.config.textColor ? r.config.textColor : t.defaultConfig.textColor);
    watch(() => r.config, () => {
    ...
    return (q, G) => (openBlock(), createElementBlock("div", Cs, [
      ...
      createBaseVNode("div", $s, [
        e.isDigitalFlop ? (openBlock(), createElementBlock("div", _s, [
          createVNode(Ba, { config: unref(o) }, null, 8, ["config"])
        ])) : (openBlock(), createElementBlock("div", {
          key: 1,
          class: "active-ring-name",
          style: normalizeStyle(unref(x))
        }, toDisplayString(unref(l)), 5)),
        createBaseVNode("div", {
          class: "active-ring-name",
          style: normalizeStyle(unref(x))
        }, toDisplayString(unref(_)), 5)
      ])
    ]));
  }
};
...
var ws = defineComponent({
  ...
  setup(e) {
    ...
    return xe(r, l, o), (_, x) => (openBlock(), createElementBlock("div", {
      id: "dv-full-screen-container",
      ref_key: "fullScreenContainer",
      ref: r
    }, [
      unref(a).ready ? renderSlot(_.$slots, "default", { key: 0 }) : createCommentVNode("", true)
    ], 512));
  }
});
var Rr = {
...
var ks = ["width", "height"];
var As = ["fill", "x", "y", "width", "height"];
var Ls = ["values", "begin"];
var Ss = ["fill", "x", "y", "width", "height"];
var Os = ["values"];
var Gs = ["values"];
var Ms = ["values"];
var Rs = ["values"];
var Ds = ["fill", "x", "y", "height"];
var Ts = ["values"];
var Fs = defineComponent({
  ...
  setup(e) {
    const r = e, a = ref(null), t = reactive([200, 50]), n = ref(4), l = ref(20), o = ref(2.5), _ = ref(o.value / 2), x = reactive(["#fff", "#0de7c2"]), z = reactive({
      mergedColor: [],
      rects: [],
      points: [],
      svgScale: [1, 1]
    ...
    return watch(() => r.color, () => {
      ...
      (openBlock(), createElementBlock("svg", {
        width: `${unref(t)[0]}px`,
        height: `${unref(t)[1]}px`,
        style: normalizeStyle(`transform:scale(${unref(z).svgScale[0]}, ${unref(z).svgScale[1]});`)
      }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(z).points, (f) => (openBlock(), createElementBlock(Fragment, { key: f }, [
          Math.random() > 0.6 ? (openBlock(), createElementBlock("rect", {
            key: 0,
            fill: unref(z).mergedColor[0],
            x: f[0] - unref(_),
            y: f[1] - unref(_),
            width: unref(o),
            height: unref(o)
            ...
            Math.random() > 0.6 ? (openBlock(), createElementBlock("animate", {
              key: 0,
              attributeName: "fill",
              values: `${unref(z).mergedColor[0]};transparent`,
              dur: "1s",
              begin: Math.random() * 2,
              repeatCount: "indefinite"
            }, null, 8, Ls)) : createCommentVNode("", true)
          ], 8, As)) : createCommentVNode("", true)
        ], 64))), 128)),
        unref(z).rects[0] ? (openBlock(), createElementBlock("rect", {
          key: 0,
          fill: unref(z).mergedColor[1],
          x: unref(z).rects[0][0] - unref(o),
          y: unref(z).rects[0][1] - unref(o),
          width: unref(o) * 2,
          height: unref(o) * 2
        }, [
          createBaseVNode("animate", {
          ...
          createBaseVNode("animate", {
            attributeName: "x",
            values: `${unref(z).rects[0][0]};${unref(z).rects[0][0] - unref(o)}`,
            dur: "2s",
            repeatCount: "indefinite"
          }, null, 8, Ms),
          createBaseVNode("animate", {
            attributeName: "y",
            values: `${unref(z).rects[0][1]};${unref(z).rects[0][1] - unref(o)}`,
            dur: "2s",
            repeatCount: "indefinite"
          }, null, 8, Rs)
        ], 8, Ss)) : createCommentVNode("", true),
        unref(z).rects[1] ? (openBlock(), createElementBlock("rect", {
          key: 1,
          fill: unref(z).mergedColor[1],
          x: unref(z).rects[1][0] - 40,
          y: unref(z).rects[1][1] - unref(o),
          width: 40,
          height: unref(o) * 2
        }, [
          y[0] || (y[0] = createBaseVNode("animate", {
            attributeName: "width",
            values: "0;40;0",
            dur: "2s",
            repeatCount: "indefinite"
          ...
          createBaseVNode("animate", {
            attributeName: "x",
            values: `${unref(z).rects[1][0]};${unref(z).rects[1][0] - 40};${unref(z).rects[1][0]}`,
            dur: "2s",
            repeatCount: "indefinite"
          }, null, 8, Ts)
...
var Bs = ["width", "height"];
var Ns = ["x", "y", "width", "height", "fill"];
var Ws = ["attributeName", "to", "dur"];
var js = ["x", "y", "fill"];
var Es = ["attributeName", "to", "dur"];
var zs = defineComponent({
  ...
  setup(e) {
    ...
    return watch(() => r.color, () => {
      n();
    }, { deep: true }), watch(() => r.reverse, () => {
      z();
    }), onMounted(() => {
      n();
    }), (E, U) => (openBlock(), createElementBlock("div", {
      ref_key: "decoration2",
      ref: a,
...
var Us = ["width", "height"];
var Xs = ["stroke", "points"];
var Qs = ["stroke", "points"];
var Ys = defineComponent({
  ...
  setup(e) {
    ...
    return watch(() => r.color, () => {
      ...
      n();
    }), (_, x) => (openBlock(), createElementBlock("div", {
      ref_key: "decoration3",
      ref: a,
      ...
      createBaseVNode("div", {
        ...
        style: normalizeStyle(e.reverse ? `width:${unref(l)}px;height:5px;animation-duration:${e.dur}s` : `width:5px;height:${unref(o)}px;animation-duration:${e.dur}s`)
      }, [
        (openBlock(), createElementBlock("svg", {
          width: e.reverse ? unref(l) : 5,
          height: e.reverse ? 5 : unref(o)
        }, [
          createBaseVNode("polyline", {
            stroke: unref(t).mergedColor[0],
            points: e.reverse ? `0, 2.5 ${unref(l)}, 2.5` : `2.5, 0 2.5, ${unref(o)}`
          }, null, 8, Xs),
          createBaseVNode("polyline", {
            class: "bold-line",
...
var Ks = ["width", "height"];
var Js = ["stroke", "points"];
var Zs = ["from", "to", "dur"];
var eu = ["stroke", "points"];
var tu = ["from", "to", "dur"];
  ...
  setup(e) {
    ...
    return (T, L) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(), createElementBlock("svg", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(t).points, (d, B) => (openBlock(), createElementBlock("rect", {
          key: B,
          fill: unref(t).mergedColor[Math.random() > 0.5 ? 0 : 1],
          x: d[0] - unref(t).halfRectWidth,
          y: d[1] - unref(t).heights[B] / 2,
          width: Wr,
          height: unref(t).heights[B]
        }, [
          createBaseVNode("animate", {
            attributeName: "y",
            values: `${d[1] - unref(t).minHeights[B] / 2};${d[1] - unref(t).heights[B] / 2};${d[1] - unref(t).minHeights[B] / 2}`,
            dur: `${unref(t).randoms[B]}s`,
            keyTimes: "0;0.5;1",
            calcMode: "spline",
          ...
          createBaseVNode("animate", {
            attributeName: "height",
            values: `${unref(t).minHeights[B]};${unref(t).heights[B]};${unref(t).minHeights[B]}`,
            dur: `${unref(t).randoms[B]}s`,
            keyTimes: "0;0.5;1",
            calcMode: "spline",
            keySplines: "0.42,0,0.58,1;0.42,0,0.58,1",
...
var pu = defineComponent({
  ...
  setup(e) {
    ...
    return (n, l) => (openBlock(), createElementBlock("div", su, [
      (openBlock(), createElementBlock("svg", uu, [
        createBaseVNode("polyline", {
          "stroke-width": "4",
          fill: "transparent",
      ...
      (openBlock(), createElementBlock("svg", du, [
        createBaseVNode("polyline", {
          "stroke-width": "4",
          fill: "transparent",
          stroke: unref(a).mergedColor[0],
    ...
    return (x, z) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(), createElementBlock("svg", {
        ...
        createBaseVNode("polyline", {
          ...
          "stroke-width": "2",
          fill: "transparent",
          points: `${o(0)}, 0 ${o(30)}, ${unref(l) / 2}`
        }, null, 8, mu),
        createBaseVNode("polyline", {
          stroke: unref(t).mergedColor[0],
          "stroke-width": "2",
          fill: "transparent",
          points: `${o(20)}, 0 ${o(50)}, ${unref(l) / 2} ${o(unref(n))}, ${unref(l) / 2}`
        }, null, 8, yu),
        createBaseVNode("polyline", {
          stroke: unref(t).mergedColor[1],
          fill: "transparent",
          "stroke-width": "3",
          points: `${o(0)}, ${unref(l) - 3}, ${o(200)}, ${unref(l) - 3}`
        }, null, 8, bu)
      ], 8, gu))
    ], 512));
  }
...
var Gu = {
  ...
  setup(e) {
    ...
    return (U, T) => (openBlock(), createElementBlock("div", {
      ref_key: "decoration9",
      ref: t,
      ...
      (openBlock(), createElementBlock("svg", {
        ...
        createBaseVNode("circle", {
          ...
          r: "38",
          fill: "transparent",
          stroke: unref(De)(unref(n).mergedColor[1] || unref(n).defaultColor[1], 30),
          "stroke-width": "1",
          "stroke-dasharray": "5, 1"
        }, null, 8, Au),
        (openBlock(true), createElementBlock(Fragment, null, renderList(new Array(20).fill(0), (L, d) => (openBlock(), createElementBlock("use", {
          key: d,
          "xlink:href": `#${unref(n).polygonId}`,
          stroke: unref(n).mergedColor[1],
          fill: Math.random() > 0.4 ? "transparent" : unref(n).mergedColor[0]
        }, [
          createBaseVNode("animateTransform", {
            attributeName: "transform",
            type: "rotate",
...
var Mu = ["width", "height"];
var Ru = ["stroke", "points"];
var Du = ["stroke", "points", "stroke-dasharray"];
var Tu = ["id", "values", "begin"];
var Fu = ["values", "begin"];
var Bu = ["stroke", "points", "stroke-dasharray"];
var Nu = ["id", "values", "begin"];
var Wu = ["values", "begin"];
var ju = ["stroke", "points", "stroke-dasharray"];
var Eu = ["id", "values", "begin"];
var zu = ["values", "begin"];
var qu = ["cy", "fill"];
var Iu = ["id", "values", "begin"];
var Hu = ["cx", "cy", "fill"];
var Vu = ["id", "values", "begin"];
var Uu = ["values", "begin"];
var Xu = ["cx", "cy", "fill"];
var Qu = ["id", "values", "begin"];
var Yu = ["values", "begin"];
var Ku = ["cx", "cy", "fill"];
var Ju = ["id", "values", "begin"];
var Zu = ["values", "begin"];
    ...
    return (x, z) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(), createElementBlock("svg", {
        ...
        createBaseVNode("polyline", {
          stroke: unref(n).mergedColor[1],
          "stroke-width": "2",
          points: `0, ${unref(o) / 2} ${unref(l)}, ${unref(o) / 2}`
        }, null, 8, Ru),
        createBaseVNode("polyline", {
          stroke: unref(n).mergedColor[0],
          "stroke-width": "2",
          points: `5, ${unref(o) / 2} ${unref(l) * 0.2 - 3}, ${unref(o) / 2}`,
          "stroke-dasharray": `0, ${unref(l) * 0.2}`,
          fill: "freeze"
        }, [
          createBaseVNode("animate", {
            id: unref(n).animationId2,
            attributeName: "stroke-dasharray",
            values: `0, ${unref(l) * 0.2};${unref(l) * 0.2}, 0;`,
            dur: "3s",
            begin: `${unref(n).animationId1}.end`,
            fill: "freeze"
          }, null, 8, Tu),
          createBaseVNode("animate", {
            attributeName: "stroke-dasharray",
            values: `${unref(l) * 0.2}, 0;0, ${unref(l) * 0.2}`,
            dur: "0.01s",
            begin: `${unref(n).animationId7}.end`,
            fill: "freeze"
          }, null, 8, Fu)
        ], 8, Du),
        createBaseVNode("polyline", {
          stroke: unref(n).mergedColor[0],
          "stroke-width": "2",
          points: `${unref(l) * 0.2 + 3}, ${unref(o) / 2} ${unref(l) * 0.8 - 3}, ${unref(o) / 2}`,
          "stroke-dasharray": `0, ${unref(l) * 0.6}`
        }, [
          createBaseVNode("animate", {
            id: unref(n).animationId4,
            attributeName: "stroke-dasharray",
            values: `0, ${unref(l) * 0.6};${unref(l) * 0.6}, 0`,
            dur: "3s",
            begin: `${unref(n).animationId3}.end + 1s`,
            fill: "freeze"
          }, null, 8, Nu),
          createBaseVNode("animate", {
            attributeName: "stroke-dasharray",
            values: `${unref(l) * 0.6}, 0;0, ${unref(l) * 0.6}`,
            dur: "0.01s",
            begin: `${unref(n).animationId7}.end`,
            fill: "freeze"
          }, null, 8, Wu)
        ...
        createBaseVNode("polyline", {
          stroke: unref(n).mergedColor[0],
          "stroke-width": "2",
          points: `${unref(l) * 0.8 + 3}, ${unref(o) / 2} ${unref(l) - 5}, ${unref(o) / 2}`,
          "stroke-dasharray": `0, ${unref(l) * 0.2}`
        }, [
          createBaseVNode("animate", {
            id: unref(n).animationId6,
            attributeName: "stroke-dasharray",
            values: `0, ${unref(l) * 0.2};${unref(l) * 0.2}, 0`,
            dur: "3s",
            begin: `${unref(n).animationId5}.end + 1s`,
            fill: "freeze"
          }, null, 8, Eu),
          createBaseVNode("animate", {
            attributeName: "stroke-dasharray",
            values: `${unref(l) * 0.2}, 0;0, ${unref(l) * 0.3}`,
            dur: "0.01s",
            begin: `${unref(n).animationId7}.end`,
            fill: "freeze"
          }, null, 8, zu)
        ...
        createBaseVNode("circle", {
          ...
          createBaseVNode("animate", {
            id: unref(n).animationId1,
            attributeName: "fill",
            values: `${unref(n).mergedColor[1]};${unref(n).mergedColor[0]}`,
            begin: `0s;${unref(n).animationId7}.end`,
            dur: "0.3s",
            fill: "freeze"
          }, null, 8, Iu)
        ], 8, qu),
        createBaseVNode("circle", {
          ...
          createBaseVNode("animate", {
            id: unref(n).animationId3,
            attributeName: "fill",
            values: `${unref(n).mergedColor[1]};${unref(n).mergedColor[0]}`,
            begin: `${unref(n).animationId2}.end`,
            dur: "0.3s",
            fill: "freeze"
          }, null, 8, Vu),
          createBaseVNode("animate", {
            attributeName: "fill",
            values: `${unref(n).mergedColor[1]};${unref(n).mergedColor[1]}`,
            dur: "0.01s",
            begin: `${unref(n).animationId7}.end`,
            fill: "freeze"
          }, null, 8, Uu)
        ...
        createBaseVNode("circle", {
          ...
          createBaseVNode("animate", {
            id: unref(n).animationId5,
            attributeName: "fill",
            values: `${unref(n).mergedColor[1]};${unref(n).mergedColor[0]}`,
            begin: `${unref(n).animationId4}.end`,
            dur: "0.3s",
            fill: "freeze"
          }, null, 8, Qu),
          createBaseVNode("animate", {
        ...
        createBaseVNode("circle", {
          ...
          createBaseVNode("animate", {
            id: unref(n).animationId7,
            attributeName: "fill",
            values: `${unref(n).mergedColor[1]};${unref(n).mergedColor[0]}`,
            begin: `${unref(n).animationId6}.end`,
            dur: "0.3s",
            fill: "freeze"
          }, null, 8, Ju),
          createBaseVNode("animate", {
...
var tc = ["width", "height"];
var rc = ["fill", "stroke"];
var nc = ["fill", "stroke", "points"];
var ac = ["fill", "stroke", "points"];
var ic = ["fill", "stroke", "points"];
var oc = ["fill", "stroke", "points"];
var lc = ["stroke", "points"];
var sc = ["stroke", "points"];
var uc = { class: "decoration-content" };
var cc = {
  __name: "index",
  props: {
    color: {
  ...
  setup(e) {
    ...
    return (_, x) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(), createElementBlock("svg", {
        ...
        createBaseVNode("polygon", {
          fill: unref(De)(unref(t).mergedColor[1] || unref(t).defaultColor[1], 10),
          stroke: unref(t).mergedColor[1],
          points: `20 ${unref(l) - 10}, 25 ${unref(l) - 4}, 55 ${unref(l) - 4} 60 ${unref(l) - 10}`
        }, null, 8, nc),
        createBaseVNode("polygon", {
          fill: unref(De)(unref(t).mergedColor[1] || unref(t).defaultColor[1], 10),
          stroke: unref(t).mergedColor[1],
          points: `${unref(n) - 20} 10, ${unref(n) - 25} 4, ${unref(n) - 55} 4 ${unref(n) - 60} 10`
        }, null, 8, ac),
        createBaseVNode("polygon", {
          fill: unref(De)(unref(t).mergedColor[1] || unref(t).defaultColor[1], 10),
          stroke: unref(t).mergedColor[1],
          points: `${unref(n) - 20} ${unref(l) - 10}, ${unref(n) - 25} ${unref(l) - 4}, ${unref(n) - 55} ${unref(l) - 4} ${unref(n) - 60} ${unref(l) - 10}`
        }, null, 8, ic),
        createBaseVNode("polygon", {
          fill: unref(De)(unref(t).mergedColor[0] || unref(t).defaultColor[0], 20),
          stroke: unref(t).mergedColor[0],
          points: `
          20 10, 5 ${unref(l) / 2} 20 ${unref(l) - 10}
          ${unref(n) - 20} ${unref(l) - 10} ${unref(n) - 5} ${unref(l) / 2} ${unref(n) - 20} 10
        `
        }, null, 8, oc),
        createBaseVNode("polyline", {
          fill: "transparent",
          stroke: unref(De)(unref(t).mergedColor[0] || unref(t).defaultColor[0], 70),
          points: `25 18, 15 ${unref(l) / 2} 25 ${unref(l) - 18}`
        }, null, 8, lc),
        createBaseVNode("polyline", {
          fill: "transparent",
          stroke: unref(De)(unref(t).mergedColor[0] || unref(t).defaultColor[0], 70),
          points: `${unref(n) - 25} 18, ${unref(n) - 15} ${unref(l) / 2} ${unref(n) - 25} ${unref(l) - 18}`
        }, null, 8, sc)
      ], 8, tc)),
...
var fc = ["width", "height"];
var dc = ["id"];
var hc = ["stroke", "stroke-width", "d"];
var vc = ["id"];
var pc = ["stop-color"];
var gc = ["r", "cx", "cy", "stroke"];
var mc = ["cx", "cy", "fill"];
var yc = ["values", "dur"];
var bc = ["dur"];
var xc = ["cx", "cy", "fill"];
...
var Ac = {
  ...
  setup(e) {
    const r = e, a = He(), t = ref(null), { width: n, height: l } = xe(t, () => {
    }, W), o = reactive({
      ...
      ringWidth: 1,
      showSplitLine: true
    }), _ = computed(() => n.value / 2), x = computed(() => l.value / 2);
    watch(() => r.color, () => {
      E(), T();
    }, { deep: true });
    function z() {
    ...
    return (q, G) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(), createElementBlock("svg", {
        ...
        createBaseVNode("defs", null, [
          createBaseVNode("g", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o).pathD, (m, y) => (openBlock(), createElementBlock("path", {
              key: m,
              stroke: unref(o).pathColor[y],
              "stroke-width": unref(n) / 2,
              fill: "transparent",
              d: m
            }, null, 8, hc))), 128))
          ], 8, dc),
          createBaseVNode("radialGradient", {
            ...
            createBaseVNode("stop", {
              offset: "100%",
              "stop-color": unref(De)(unref(o).mergedColor[1] || unref(o).defaultColor[1], 30),
              "stop-opacity": "1"
            }, null, 8, pc)
          ], 8, vc)
        ]),
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o).circleR, (m) => (openBlock(), createElementBlock("circle", {
          key: m,
          r: m,
          cx: unref(_),
          cy: unref(x),
          stroke: unref(o).mergedColor[1],
          "stroke-width": 0.8,
          fill: "transparent"
        }, null, 8, gc))), 128)),
        createBaseVNode("circle", {
        ...
        createBaseVNode("circle", {
          ...
          cx: unref(_),
          cy: unref(x),
          fill: unref(o).mergedColor[1]
        }, null, 8, xc),
        unref(o).showSplitLine ? (openBlock(), createElementBlock("g", Cc, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o).splitLinePoints, (m) => (openBlock(), createElementBlock("polyline", {
            key: m,
            points: m,
            stroke: unref(o).mergedColor[1],
            "stroke-width": 0.5,
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o).arcD, (m) => (openBlock(), createElementBlock("path", {
          key: m,
          d: m,
          stroke: unref(o).mergedColor[1],
          "stroke-width": "2.3",
        ...
        createBaseVNode("use", {
          "xlink:href": `#${unref(o).gId}`
        }, [
          createBaseVNode("animateTransform", {
            attributeName: "transform",
            type: "rotate",
            values: `0, ${unref(_)} ${unref(x)};360, ${unref(_)} ${unref(x)}`,
            dur: `${e.scanDur}s`,
            repeatCount: "indefinite"
          }, null, 8, wc)
        ], 8, Pc)
...
var Lc = ["left-top", "right-top", "left-bottom", "right-bottom"];
var Sc = ["#4fd2dd", "#235fa7"];
var Oc = defineComponent({
  props: qe,
  setup(e) {
    const r = ref(null), a = Ie(Sc, toRef(e, "color")), {
      width: t,
      height: n,
      initWH: l
    } = xe(r);
...
var Gc = ["#fff", "rgba(255, 255, 255, 0.6)"];
var Mc = defineComponent({
  props: qe,
  setup(e) {
    const r = ref(null), a = Ie(Gc, toRef(e, "color")), {
      width: t,
      height: n,
      initWH: l
    } = xe(r);
...
var Wc = ["rgba(255, 255, 255, 0.35)", "rgba(255, 255, 255, 0.20)"];
...
var Ec = ["rgba(255, 255, 255, 0.35)", "gray"];
...
var qc = ["rgba(128,128,128,0.3)", "rgba(128,128,128,0.5)"];
...
var Vc = ["#235fa7", "#4fd2dd"];
var Uc = defineComponent({
  props: Hc,
  setup(e) {
    const r = He(), a = ref(null), t = reactive({
      ...
      height: l,
      initWH: o
    } = xe(a), _ = computed(() => (n.value + l.value - 5) * 2), x = computed(() => e.reverse ? `M 2.5, 2.5 L 2.5, ${l.value - 2.5} L ${n.value - 2.5}, ${l.value - 2.5} L ${n.value - 2.5}, 2.5 L 2.5, 2.5` : `M2.5, 2.5 L${n.value - 2.5}, 2.5 L${n.value - 2.5}, ${l.value - 2.5} L2.5, ${l.value - 2.5} L2.5, 2.5`), z = Ie(Vc, toRef(e, "color"));
    return {
      width: n,
      height: l,
      initWH: o,
...
var Xc = ["#11eefd", "#0078d2"];
var Qc = defineComponent({
  props: qe,
  setup(e) {
    const r = He(), a = ref(null), {
      width: t,
      height: n,
      initWH: l
    } = xe(a), o = reactive({
...
var Yc = ["left-top", "right-top", "left-bottom", "right-bottom"];
var Kc = ["#1d48c4", "#d3e1f8"];
var Jc = defineComponent({
  props: qe,
  setup(e) {
    const r = ref(null), {
...
var ef = defineComponent({
  ...
  setup(e) {
    const r = He(), a = ref(null), {
      ...
      height: n,
      initWH: l
    } = xe(a), o = ref(`border-box-11-filterId-${r}`), _ = Ie(xa, toRef(e, "color"));
    return {
      width: t,
      height: n,
      initWH: l,
...
var tf = defineComponent({
  ...
  setup(e) {
    const r = He(), a = ref(null), {
      ...
      height: n,
      initWH: l
    } = xe(a), o = ref(`borderr-box-12-filterId-${r}`), _ = Ie(dt, toRef(e, "color"));
    return {
      width: t,
      height: n,
      filterId: o,
